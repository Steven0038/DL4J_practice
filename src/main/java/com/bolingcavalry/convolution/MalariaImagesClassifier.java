...
/**
 * source code from ref.https://www.rcp-vision.com/convolutional-neural-networks-with-eclipse-deeplearning4j.
 *
 * This is a GPU version with shorten number of training set to total 8000 pictures
 *
 * @see <a href="https://www.kaggle.com/iarunava/cell-images-for-detecting-malaria">malaria dataset</a>
 */
public class MalariaImagesClassifier {
	//Height and widht in pixel of each image
	private static final int HEIGHT = 100;
	private static final int WIDTH = 100;
	//The total number of images into the training and testing set
//	private static final int N_SAMPLES_TRAINING = 13779+13779; // original image number of pictures of dataset
	private static final int N_SAMPLES_TRAINING = 4000+4000; // number of Parasitized pics + Uninfected pics
...
//        learningRateSchedule.put(1000, 0.001);
	...
	private static DataSetIterator getDataSetIterator(String folderPath, int nSamples) throws IOException {
		...
		for (File digitFolder : digitFolders) {
			...
			int labelDigit = digitFolder.getName().equalsIgnoreCase("Parasitized") ? 1 : 0 ; // this demo doesn't split dataset to train and test, but label train data by folder name
